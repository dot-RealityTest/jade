...
Muxy/
  ...
  Views/
    ...
    Components/
      ...
      CommandPaletteOverlay.swift  Cmd+K unified command palette for app actions, remote commands, remote spaces, snippets, files, and worktrees, including inline confirmation for destructive remote actions
