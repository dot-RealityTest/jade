...
Muxy/
  ...
  Models/
    ...
    CommandPaletteItem.swift  Unified command palette result model, section headers, aliases, remote actions, and remote-space ordering
  ...
  Services/
    ...
    RemoteCommandBuilder.swift Wraps selected Linux commands through a remote space's SSH profile
  ...
  Views/
    ...
    Components/
      ...
      CommandPaletteOverlay.swift  Cmd+K unified command palette for app actions, remote commands, remote spaces, snippets, files, and worktrees
