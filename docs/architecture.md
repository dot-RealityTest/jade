...
Muxy/
  ...
  Models/
    ...
    RemoteSpace.swift         Named remote machine profile with SSH fields, generated command, tab color, and backing directory
  ...
  Services/
    ...
    RemoteSpaceLauncher.swift Creates/selects dedicated remote machine project-spaces from the macOS menu using the profile command
  ...
  Views/
    ...
    Settings/
      ...
      RemoteSpacesSettingsView.swift  Remote machine profile add/edit/delete tab with generated SSH command preview
